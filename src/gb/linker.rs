...
pub fn link(opcode: u8) -> Option<Opcode> {
  ...
  match opcode {
    0x00 => Some(NOP),
        ...
        0x17 => Some(RLA),
        0x18 => Some(JR(Condition::Always, ImmI8)),
        ...
        0x1F => Some(RRA),
        0x20 => Some(JR(Condition::NZ, ImmI8)),
        ...
        0x27 => Some(DAA),
        0x28 => Some(JR(Condition::Z, ImmI8)),
        ...
        0x2F => Some(CPL),
        0x30 => Some(JR(Condition::NC, ImmI8)),
        ...
        0x37 => Some(SCF),
        0x38 => Some(JR(Condition::C, ImmI8)),
        ...
        0xC0 => Some(RET(Condition::NZ)),
        0xC1 => Some(POP(Reg16(BC))),
        0xC2 => Some(JP(Condition::NZ, ImmU16)),
        0xC3 => Some(JP(Condition::Always, ImmU16)),
        0xC4 => Some(CALL(Condition::NZ, ImmU16)),
        0xC5 => Some(PUSH(Reg16(BC))),
        0xC6 => Some(ADD(Reg8(A), ImmU8)),
        0xC7 => Some(RST(0x00)),
        0xC8 => Some(RET(Condition::Z)),
        0xC9 => Some(RET(Condition::Always)),
        0xCA => Some(JP(Condition::Z, ImmU16)),
        0xCB => Some(PREFIX),
        0xCC => Some(CALL(Condition::Z, ImmU16)),
        0xCD => Some(CALL(Condition::Always, ImmU16)),
        0xCE => Some(ADC(Reg8(A), ImmU8)),
        0xCF => Some(RST(0x08)),
        0xD0 => Some(RET(Condition::NC)),
        0xD1 => Some(POP(Reg16(DE))),
        0xD2 => Some(JP(Condition::NC, ImmU16)),
        0xD3 => None,
        0xD4 => Some(CALL(Condition::NC, ImmU16)),
        0xD5 => Some(PUSH(Reg16(DE))),
        0xD6 => Some(SUB(Reg8(A), ImmU8)),
        0xD7 => Some(RST(0x10)),
        0xD8 => Some(RET(Condition::C)),
        0xD9 => Some(RETI),
        0xDA => Some(JP(Condition::C, ImmU16)),
        0xDB => None,
        0xDC => Some(CALL(Condition::C, ImmU16)),
        0xDD => None,
        ...
        0xE9 => Some(JP(Condition::Always, Reg16(HL))),
